...
class VnExpress:
    def __init__(self, start_date, end_date, export_dir):
        self.url = "https://dantri.com.vn/the-thao/{}.htm"
        ...
        self.output = os.path.join(self.export_dir,
                                   "dantri_" + re.sub(r"/", ".", start_date) + "-" + re.sub(r"/", ".", end_date))
    ...
    def crawl(self):
        while self.crawl_able():
            ...
            if res.status_code == 200:
                ...
                news_articles = soup.select('a.icon-detail')
                for news_article in news_articles:
                    # time.sleep(randint(1, 5))
                    url = "https://dantri.com.vn" + news_article['href']
...
if __name__ == '__main__':
    vnexpress = VnExpress('06/04/2005', '31/05/2019', '../data/dantri_thethao')
    vnexpress.crawl()
