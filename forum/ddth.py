...
def is_post(url):
    return re.match(r'https?://ddth\.com/showthread\.php/.+', url) is not None
...
def correct_url(url):
    ...
    if not url.startswith('http'):
        url = "https://ddth.com/" + url
    url = re.sub('#.+$', '', url)
    url = re.sub('/*$', '/', url)
    if re.match(r'https?://ddth\.com.+', url):
        return url
    return ''


home_url = "https://www.ddth.com/forum.php/"
...
def get_comment(url):
    ...
    with open('ddth.txt', 'a+', encoding='utf8') as fp:
