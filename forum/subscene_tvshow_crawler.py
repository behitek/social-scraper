...
SAVE_DIR = "/home/lap60313/data/vpbank/subtitle/tvshow/"
...
CRAWLED_DATE_LOG = "do_not_remove.date.tvshow"
# get latest crawl date
crawled_date = '12/19/2019 9:48:00 AM'
try:
...
for i in range(1, 101):
    ...
    try:
        url = "https://subscene.com/browse/latest/series/{}".format(i)
        driver.get(url)
